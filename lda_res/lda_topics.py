...
repos = next(os.walk(str(parent)+'/java'))[2]
#repos = ["/cpp/02_issue.txt","/cpp/blink_issue.txt","/cpp/BlueshiftEngine_issue.txt","/cpp/cmake-init_issue.txt"]
#file_path = str(parent)+"/cpp/cpbook-code_pullreq.txt"

for i in range(1):
	file_path = str(parent)+"/java/"+repos[i]

	f = open(file_path,encoding="utf-8-sig", errors='ignore')
...
# print(data_lemmatized[:1])   
	if(len(data_lemmatized)<1):
		data_lemmatized = ['test1','test2','test3','test4','test5','test6','test7','test8','test9','test10']
...
# View
# print(corpus[:1])
	savname = (file_path.split('/')[7]).split('.')[0]
#print(file_path.split('/'))

	
	if __name__ == "__main__":
		tFile = str(savname)+"topics.txt"
		topics_file = open(tFile,'w',encoding="utf-8-sig", errors='ignore')
		coherence = str(savname)+"coh.txt"
