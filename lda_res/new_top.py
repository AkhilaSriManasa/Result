...
filename = "/python/arguman.org_commit.txt"
f = open(str(parent)+str(filename),encoding="utf-8-sig", errors='ignore')
fname = (filename.split('/')[2]).split('.')[0]
